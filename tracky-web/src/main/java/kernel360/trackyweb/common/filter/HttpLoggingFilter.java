package kernel360.trackyweb.common.filter;
...
public class HttpLoggingFilter implements Filter {
	...
	private String getHeaders(HttpServletRequest request) {
		...
		request.getHeaderNames().asIterator().forEachRemaining(
			headerName -> headerString.append(headerName)
				.append(": ")
	...
	private String getHeaders(HttpServletResponse response) {
		...
		it.forEachRemaining(headerName ->
			headerString
				.append(headerName)
				.append(": ")
				.append(String.join(", ", response.getHeaders(headerName)))
		);
